...
<catch event="nomatch">
<prompt>Sorry,Please enter details</prompt>
<goto next="#action_1"/>
</catch>
</form>
...
<goto next="'.$USSD->http_client.'/deleteReminder.php?MSISDN=%ORIG%"/>
</block>
</form>
<form id="action_3" name="help">

<block name="oc_ActionUrl">
<goto next="'.$USSD->http_client.'/help.php?MSISDN=%ORIG%"/>
</block>
</form>
<form id="action_4" name="next_d">

<block name="oc_ActionUrl">
<goto next="'.$USSD->http_client.'/type.php?MSISDN=%ORIG%&amp;details=%Rdetails%"/>
</block>
</form>
</vxml>
';
